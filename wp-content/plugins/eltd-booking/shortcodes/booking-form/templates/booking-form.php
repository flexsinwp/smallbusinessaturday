			...
			<div class="eltd-rf-holder clearfix">
				<div class="eltd-rf-field-holder clearfix">
					<select name="partySize" class="eltd-ot-people">
						<option value="1"><?php esc_html_e('1 Person', 'eltd_restaurant'); ?></option>
						<option value="2"><?php esc_html_e('2 People', 'eltd_restaurant'); ?></option>
						<option value="3"><?php esc_html_e('3 People', 'eltd_restaurant'); ?></option>
						<option value="4"><?php esc_html_e('4 People', 'eltd_restaurant'); ?></option>
						<option value="5"><?php esc_html_e('5 People', 'eltd_restaurant'); ?></option>
						<option value="6"><?php esc_html_e('6 People', 'eltd_restaurant'); ?></option>
						<option value="7"><?php esc_html_e('7 People', 'eltd_restaurant'); ?></option>
						<option value="8"><?php esc_html_e('8 People', 'eltd_restaurant'); ?></option>
						<option value="9"><?php esc_html_e('9 People', 'eltd_restaurant'); ?></option>
						<option value="10"><?php esc_html_e('10 People', 'eltd_restaurant'); ?></option>
					</select>
				</div>
				<div class="eltd-rf-field-holder clearfix">
				...
				<div class="eltd-rf-btn-holder">
					<?php if(eltd_booking_theme_installed()) { ?>
						<?php echo findme_elated_get_button_html(
							array(
								'type'         => 'solid',
								'html_type'    => 'button',
