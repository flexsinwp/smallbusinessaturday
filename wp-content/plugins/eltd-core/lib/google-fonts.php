<?php
if ( ! function_exists( 'findme_elated_init_google_fonts_array' ) ) {
    function findme_elated_init_google_fonts_array() {

        global $findme_elated_fonts_array;
        $findme_elated_fonts_array =
        array (
            0 =>
                array (
    ...
    add_action('after_setup_theme', 'findme_elated_init_google_fonts_array');
}