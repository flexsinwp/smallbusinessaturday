<div class="eltd-team-list-holder <?php echo esc_attr($holder_classes); ?>">
	<div class="eltd-tl-inner <?php echo esc_attr($inner_classes); ?>" <?php echo findme_elated_get_inline_attrs($data_attrs); ?>>
		<?php
