...
if(!function_exists('eltd_core_include_custom_post_types_meta_boxes')) {
	...
	add_action('findme_elated_before_meta_boxes_map', 'eltd_core_include_custom_post_types_meta_boxes');
}
...
if(!function_exists('eltd_core_include_custom_post_types_global_options')) {
	...
	add_action('findme_elated_before_options_map', 'eltd_core_include_custom_post_types_global_options', 1);
}