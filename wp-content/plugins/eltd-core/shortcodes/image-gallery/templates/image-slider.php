...
<div class="eltd-image-gallery">
	<div class="eltd-ig-slider eltd-owl-slider" <?php echo findme_elated_get_inline_attrs($slider_data); ?>>
		<?php foreach ($images as $image) {
			if ($pretty_photo) { ?>
				<a itemprop="image" class="eltd-ig-lightbox" href="<?php echo esc_url($image['url'])?>" data-rel="prettyPhoto[single_pretty_photo]" title="<?php echo esc_attr($image['title']); ?>">
