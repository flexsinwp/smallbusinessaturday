...
class VerticalSplitSliderContentItem implements Lib\ShortcodeInterface {
	...
	function __construct() {
		$this->base = 'eltd_vertical_split_slider_content_item';
	...
	public function vcMap() {
		if(function_exists('vc_map')) {
			vc_map(
				array(
					'name'      => esc_html__( 'Elated Slide Content Item', 'eltd-core' ),
					'base'      => $this->base,
					'icon'      => 'icon-wpb-vertical-split-slider-content-item extended-custom-icon',
					'category'  => esc_html__( 'by ELATED', 'eltd-core' ),
					'as_parent' => array( 'except' => 'vc_row' ),
					'as_child'  => array( 'only' => 'eltd_vertical_split_slider_left_panel, eltd_vertical_split_slider_right_panel' ),
					...
					'params'    => array(
						...
						array(
							...
							'description' => esc_html__( 'Insert padding in format: Top Right Bottom Left (e.g. 0px 0px 1px 0px)', 'eltd-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'alignment',
							'heading'    => esc_html__( 'Content Alignment', 'eltd-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Header/Bullets Style', 'eltd-core' ),
							'value'      => array(
								esc_html__( 'Default', 'eltd-core' ) => '',
	...
	public function render($atts, $content = null) {
		...
		$html = eltd_core_get_shortcode_module_template_part('templates/vertical-split-slider-content-item-template', 'vertical-split-slider', '', $params);
