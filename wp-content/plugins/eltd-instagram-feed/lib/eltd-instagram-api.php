...
include 'eltd-instagram-helper.php';

/**
 * Class ElatedInstagramApi
 */
class ElatedInstagramApi {
    /**
    ...
    private $apiURL;
    /**
     * @var ElatedInstagramApi instance of current class
     */
    private static $instance;

    /**
     * Helper object
     * @var ElatedInstagramHelper
     */
    private $helper;

    const CODE_OPTION_NAME = 'eltd_instagram_code';
    const USER_ID_OPTION_NAME = 'eltd_instagram_user_id';
    const ACCESS_TOKEN_OPTION_NAME = 'eltd_instagram_access_token';
    const CODE_REDIRECT_URI_OPTION_NAME = 'eltd_instagram_code_redirect_uri';
    ...
    private function __construct() {
	    ...
	    $this->helper = new ElatedInstagramHelper();
    }
     ...
     * @return string
     *
     * @see ElatedInstagramApi::buildCurrentPageURI()
     */
     ...
     *
     * @see ElatedInstagramApi::fetchData()
     */
     ...
     * @return stdClass
     *
     * @see ElatedInstagramApi::getAccessToken()
     */
