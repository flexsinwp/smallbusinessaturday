...
<div class="eltd-membership-dashboard-page">
	...
	<div>
		<form method="post" id="eltd-membership-update-profile-form" enctype="multipart/form-data">
 ...
 <!------------Custom field for profile image----------------------------->

         <div class="eltd-membership-input-holder">
                    <label for="profile-image"><?php esc_html_e( 'Profile', 'eltd-membership' ); ?></label><br>
                    <input class="eltd-membership-input" type="file" name="profile_image " id="profile-image" data-file_types="jpg|jpeg|jpe|gif|png"value="">
                           <small class="description">Maximum file size: 3 MB.   </small>
