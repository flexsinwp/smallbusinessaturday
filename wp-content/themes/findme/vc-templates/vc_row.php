...
$row_content_width = $anchor = $content_text_aligment = $eltd_row_wrapper_start = $eltd_row_wrapper_end = '';
...
if (!empty($content_text_aligment)){
	$css_classes[] = 'eltd-content-aligment-' . $content_text_aligment;
}
...
$parallax_speed = 1.5; //default value
...
if($row_content_width === 'grid'){
	$eltd_row_wrapper_start .= '<div class="eltd-row-grid-section">';
	$eltd_row_wrapper_end .= '</div>';
}
