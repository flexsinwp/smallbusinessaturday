...
class FindmeElatedSimpleLineIcons implements iFindmeElatedIconCollection {
	...
	public function setSocialIconsArray() {
		$this->socialIcons = array(
			''                        => '',
			'icon-social-behance'     => esc_html__('Behance', 'findme'),
			'icon-social-dribbble'    => esc_html__('Dribbble', 'findme'),
			'icon-social-dropbox'     => esc_html__('Dropbox', 'findme'),
			'icon-social-facebook'    => esc_html__('Facebook', 'findme'),
			'icon-social-foursquare'  => esc_html__('Foursquare', 'findme'),
			'icon-social-github'      => esc_html__('Github', 'findme'),
			'icon-social-gplus'       => esc_html__('Google Plus', 'findme'),
			'icon-social-instagram'   => esc_html__('Instagram', 'findme'),
			'icon-social-linkedin'    => esc_html__('LinkedIn', 'findme'),
			'icon-social-pintarest'   => esc_html__('Pinterest', 'findme'),
			'icon-social-reddit'      => esc_html__('Reddit', 'findme'),
			'icon-social-skype'       => esc_html__('Skype', 'findme'),
			'icon-social-soundcloud'  => esc_html__('Soundcloud', 'findme'),
			'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'findme'),
			'icon-social-spotify'     => esc_html__('Spotify', 'findme'),
			'icon-social-tumblr'      => esc_html__('Tumblr', 'findme'),
			'icon-social-twitter'     => esc_html__('Twitter', 'findme'),
			'icon-social-youtube'     => esc_html__('Youtube', 'findme')
		);
	}
