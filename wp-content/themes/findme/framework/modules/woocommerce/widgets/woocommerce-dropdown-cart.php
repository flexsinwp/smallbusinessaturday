						...
						<ul>
							...
							<div class="eltd-cart-bottom">
								...
								<div class="eltd-btn-holder clearfix">
									<a itemprop="url" href="<?php echo wc_get_cart_url(); ?>" class="eltd-view-cart" data-title="<?php esc_html_e('view bag & checkout','findme'); ?>"><span><?php esc_html_e('view bag & checkout','findme'); ?></span></a>
								</div>
...
add_action( 'widgets_init', create_function( '', 'register_widget( "FindmeElatedWoocommerceDropdownCart" );' ) );
