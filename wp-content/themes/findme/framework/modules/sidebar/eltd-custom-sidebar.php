...
if (!class_exists('FindmeElatedSidebar')) {

    class FindmeElatedSidebar
    {
        ...
        function __construct() {
            ...
            $this->title = esc_html__('Custom Widget Area', 'findme');
        ...
        function template_add_widget_field() {
            ...
            echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '" . esc_html__('Enter Name of the new Widget Area', 'findme') . "' name='eltd-add-widget' /></span>";
            echo "\n    <input class='button' type='submit' value='" . esc_html__('Add Widget Area', 'findme') . "' />";
            echo "\n    " . $nonce;
            echo "\n  </form>";
            echo "\n</script>\n";
        }
        ...
        function register_custom_sidebars() {
            ...
            $args = apply_filters('findme_elated_custom_widget_args', $args);
