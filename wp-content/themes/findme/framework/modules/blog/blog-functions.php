...
if (!function_exists('findme_elated_modify_read_more_link')) {
	...
	function findme_elated_modify_read_more_link() {
        ...
        if(findme_elated_core_plugin_installed()) {
            $link .= findme_elated_get_button_html(array(
                'link' => get_permalink() . '#more-' . get_the_ID(),
                'text' => esc_html__('Continue reading', 'findme')
            ));
        } else {
            $link .='<a itemprop="url" href="' . get_permalink() . '#more-' . get_the_ID() . '" target="_self" class="eltd-btn eltd-btn-large eltd-btn-solid">';
            $link .= '<span class="eltd-btn-text">';
            $link .= esc_html__('Continue reading', 'findme');
            $link .= '</span></a>';
        }
