...
class FindmeElatedSocialIconWidget extends FindmeElatedWidget {
    ...
    public function widget($args, $instance) {
        ...
        <a class="eltd-social-icon-widget-holder eltd-icon-has-hover" <?php echo findme_elated_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php findme_elated_inline_style($icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">
