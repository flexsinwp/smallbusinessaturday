...
if ( ! function_exists( 'findme_elated_get_hide_dep_for_header_main_menu_options' ) ) {
	function findme_elated_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'findme_elated_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'findme_elated_header_main_navigation_options_map' ) ) {
	function findme_elated_header_main_navigation_options_map() {
		$hide_dep_options = findme_elated_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = findme_elated_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'findme' ),
		...
		findme_elated_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'findme' )
			)
		);
		...
		$drop_down_group = findme_elated_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'findme' )
			)
		);
		
		$drop_down_row1 = findme_elated_add_admin_row(
			array(
		...
		findme_elated_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'findme' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'findme' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'findme' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'findme' )
				)
			)
		);
		...
		findme_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dropdown Position', 'findme' ),
				'description'   => esc_html__( 'Enter value in percentage of entire header height', 'findme' ),
				'args'          => array(
					'col_width' => 3,
					'suffix'    => '%'
				)
		...
		$first_level_group = findme_elated_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'findme' )
			)
		);
		...
		findme_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'findme' ),
			)
		);
		...
		findme_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'findme' ),
			)
		);
		
		$first_level_row4 = findme_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		findme_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'findme' ),
			)
		);
		...
		findme_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'findme' ),
			)
		);
		
		$first_level_row5 = findme_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = findme_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = findme_elated_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		findme_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'findme' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		findme_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'findme' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = findme_elated_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'findme' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'findme' )
			)
		);
		...
		$second_level_wide_group = findme_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'findme' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'findme' )
			)
		);
		
		$second_level_wide_row1 = findme_elated_add_admin_row(
			array(
		...
		$second_level_wide_row2 = findme_elated_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = findme_elated_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = findme_elated_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'findme' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'findme' )
			)
		);
		...
		$third_level_row3 = findme_elated_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = findme_elated_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'findme' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'findme' )
			)
		);
		
		$third_level_wide_row1 = findme_elated_add_admin_row(
			array(
		...
		$third_level_wide_row2 = findme_elated_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = findme_elated_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'findme_elated_header_main_navigation_options_map', 'findme_elated_header_main_navigation_options_map', 10, 1 );
}