...
if ( ! function_exists( 'findme_elated_get_hide_dep_for_header_vertical_menu_options' ) ) {
	function findme_elated_get_hide_dep_for_header_vertical_menu_options() {
		$hide_dep_options = apply_filters( 'findme_elated_header_vertical_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'findme_elated_header_vertical_navigation_options_map' ) ) {
	function findme_elated_header_vertical_navigation_options_map() {
		$hide_dep_options = findme_elated_get_hide_dep_for_header_vertical_menu_options();
		
		$panel_vertical_main_menu = findme_elated_add_admin_panel(
			array(
				'title'           => esc_html__( 'Vertical Main Menu', 'findme' ),
		...
		$drop_down_group = findme_elated_add_admin_group(
			array(
				'parent'      => $panel_vertical_main_menu,
				'name'        => 'vertical_drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'findme' ),
				'description' => esc_html__( 'Set a style for dropdown menu', 'findme' )
			)
		);
		
		$vertical_drop_down_row1 = findme_elated_add_admin_row(
			array(
		...
		findme_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Top Margin', 'findme' ),
				'args'          => array(
					'suffix' => 'px'
				),
		...
		findme_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Bottom Margin', 'findme' ),
				'args'          => array(
					'suffix' => 'px'
				),
				'parent'        => $vertical_drop_down_row1
		...
		$group_vertical_first_level = findme_elated_add_admin_group(
			array(
				'name'        => 'group_vertical_first_level',
				'title'       => esc_html__( '1st level', 'findme' ),
				'description' => esc_html__( 'Define styles for 1st level menu', 'findme' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_first_level_1 = findme_elated_add_admin_row(
			array(
		...
		findme_elated_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'findme' ),
				'parent'        => $row_vertical_first_level_1
			)
		);
		...
		$row_vertical_first_level_2 = findme_elated_add_admin_row(
			array(
		...
		$row_vertical_first_level_3 = findme_elated_add_admin_row(
			array(
		...
		$group_vertical_second_level = findme_elated_add_admin_group(
			array(
				'name'        => 'group_vertical_second_level',
				'title'       => esc_html__( '2nd level', 'findme' ),
				'description' => esc_html__( 'Define styles for 2nd level menu', 'findme' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_second_level_1 = findme_elated_add_admin_row(
			array(
		...
		$row_vertical_second_level_2 = findme_elated_add_admin_row(
			array(
		...
		$row_vertical_second_level_3 = findme_elated_add_admin_row(
			array(
		...
		$group_vertical_third_level = findme_elated_add_admin_group(
			array(
				'name'        => 'group_vertical_third_level',
				'title'       => esc_html__( '3rd level', 'findme' ),
				'description' => esc_html__( 'Define styles for 3rd level menu', 'findme' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_third_level_1 = findme_elated_add_admin_row(
			array(
		...
		$row_vertical_third_level_2 = findme_elated_add_admin_row(
			array(
		...
		$row_vertical_third_level_3 = findme_elated_add_admin_row(
			array(
	...
	add_action( 'findme_elated_additional_header_main_navigation_options_map', 'findme_elated_header_vertical_navigation_options_map', 10, 1 );
}