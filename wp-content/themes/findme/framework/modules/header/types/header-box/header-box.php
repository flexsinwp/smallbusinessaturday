...
class HeaderBox extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$parameters = apply_filters( 'findme_elated_header_box_parameters', $parameters );
	...
	public function calculateHeightOfTransparency() {
		...
		if ( ( ( $sliderExists || $contentBehindHeader ) && findme_elated_is_top_bar_enabled() )
		     || findme_elated_is_top_bar_enabled() && findme_elated_is_top_bar_transparent()
		) {
			$transparencyHeight = $this->menuAreaHeight + findme_elated_get_top_bar_height();
		}
